...
function Footer() {
    return (
        <div className='py-12 px-3 max-w-7xl mx-auto flex justify-between flex-col md:flex-row ld:flex-row mt-3 footer'>
            <div className='flex flex-col gap-1'>
                <h5 style={{ fontSize: '18.4px' }} className='mb-2'>ComicCove</h5>
                <p style={{ fontSize: '16px' }}>© {new Date().getFullYear()} ComicCove All Rights Reserved.</p>
            </div>
            <div className='flex justify-start items-center gap-24 mr-10 text-white'>
                <div className="twitter-logo flex flex-wrap justify-center content-center cursor-pointer text-white hover:text-[#ea580c]">
                    <svg width="30px" height="30px" viewBox="0 0 1200 1227" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" fill="currentColor" />
                    </svg>
                </div>
                <div className="telegram flex flex-wrap justify-center content-center cursor-pointer text-white hover:text-[#ea580c]">
                    <svg width="60px" height="60px" viewBox="30 0 100 200" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="medium-logo flex flex-wrap justify-center content-center cursor-pointer text-white hover:text-[#ea580c]">
