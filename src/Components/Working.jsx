    ...
    return (
        <div className='my-28 flex px-5 lg:flex-row md:flex-row flex-col justify-between max-w-6xl mx-auto items-center'>
            <div className='flex flex-col' style={{ width: '48%' }}>
                ...
                <p className='my-6' style={{ fontSize: '16px' }}>Embrace the power of a truly decentralized content delivery network (dCDN) with CubicCove's node network. Anchored by community involvement, this system not only enhances content distribution but also offers members the opportunity to fortify the network. By establishing and managing a node, contributors champion network growth and security, all while reaping rewards in tokens.</p>
